...
def draw_move(surface: pygame.Surface, player: type.Player, b: type.Board) -> None:
...
def draw_delete(surface: pygame.Surface, player: type.Player, b: type.Board) -> None:
    global global_running
...
def draw_hover(surface: pygame.Surface, player: type.Player, b: type.Board) -> None:
    global global_running
...
def update_board(surface: pygame.Surface, b: type.Board) -> None:
    surface_width, surface_height = surface.get_size()
    size = get_size(surface)
    image_margin_left_template = (surface_width - size) // 2
    image_margin_top_template = (surface_height - size) // 2
